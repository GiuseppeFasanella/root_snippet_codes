...
**options**: The second parameter is the fitting option. Here is the list of fitting options:
...
o "L" Use log likelihood method (default is chi-square method). You can use log likelihood only with histograms, 
not with graphs!
