...
variables=['probe_Pho_et','probe_Pho_missingHits']
#variables=['probe_Pho_missingHits','probe_Pho_sieie','probe_Pho_sipip','probe_Pho_nTrkSolidCone03','probe_Pho_full5x5x_r9','probe_Pho_hoe','pair_mass']
#variables=['probe_Pho_missingHits','probe_Pho_abseta']
...
#file_histograms=TFile.Open('Plots/histograms.root')
file_histograms=TFile.Open('Plots/histograms_et.root')
...
for variable in variables:
   ...
   for sel_name in sel_names:
      ...
      for y_scale in y_scales:
         ...
         pad1.cd();
         h_MC=file_histograms.Get("h_MC_"+sel_name+"_"+variable)
         h_data=file_histograms.Get("h_data_"+sel_name+"_"+variable)
      ...
      #ratioGraph.GetYaxis().SetRangeUser(1- 2*ratioGraph.GetRMS(2),1+2*ratioGraph.GetRMS(2));
         #ratioGraph.GetYaxis().SetRangeUser(0.2,4);
            ...
            canvas.SaveAs("~/scratch1/www/TP/76/Zeeg/data_MC/"+variable+"_"+sel_name+"_"+y_scale+".png")
